...
import { part1 as d10p1, part2 as d10p2 } from "../day10";
...
describe("Testing day 9, part 2", () => {
  it("should equal 35106", () => {
    const result = d9p2();
    expect(result).to.equal(35106);
  });
});

describe("Testing day 10, part 1", () => {
  it("should equal 314", () => {
    const result = d10p1();
